...
public abstract class MiniGameDataModel
{
    ...
    // THIS IS FOR RENDERING A POTENTIALLY SCROLLING GAME WORLD
    // INSIDE A VIEWPORT
    ...
    /**
     * For accessing the ArrayList containing the debug text being stored for
     * optional display.
     *
     * return the ArrayList that stores all the debug text.
     */
    ...
    /**
     * Accessor method for getting the viewport.
     */
    ...
    /**
     * Asks if a game level is started yet or no. 
     */
    public boolean notStarted()
    {
        return gameState == MiniGameState.NOT_STARTED;
    }
